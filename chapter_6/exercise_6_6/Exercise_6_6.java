 ...
 */
public class Exercise_6_6 extends JPanel {
    
    public static void main(String[] args) {
        JFrame window = new JFrame("Sub Killer Game");
        Exercise_6_6 content = new Exercise_6_6();
    ...
    private int hits, misses;	// Saving player's hits and misses of a sub
    ...
    public Exercise_6_6() {
        ...
        timer = new Timer( 25, action );  // Fires every 30 milliseconds.
    ...
    private class Bomb {
        ...
        /**
         * Constructor creates a bomb that is initially attached to boat.
         */
        Bomb() { 
            isFalling = false;
            misses = 0;
