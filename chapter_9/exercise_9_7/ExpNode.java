...
abstract public class ExpNode {
  ...
  /**
   * Creates new ExpNode out of given ExpNode, which will represent a derivative
   * of that expression. 
   * @return Expression node representing a derivative.
   */
  abstract ExpNode derivative();
  
  /**
   * Prints the infix evaluation of the expression.
   */
