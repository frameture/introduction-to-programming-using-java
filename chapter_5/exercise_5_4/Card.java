 ...
 *  A card my represent one of the 4 suits and one of the 13 numerical values.
 *  
 ...
 */
public class Card {
  // suits and numerical values of cards;
...
/**
* Return the concatenated String of the 'suit' and 'value' variables of Card class.
*/
